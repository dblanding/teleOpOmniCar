/*
 * autoOp code for an "Omni wheel" type car with 4 motors.
 * Adapted from teleOpOmniCar1 to accept input from a RasPi via USB
 * serial cable instead of getting input on Serial2 over Bluetooth.
...
void setup()
{
  ...
  Serial.println("Hello from OmniWheelCar");
  AFMS.begin();
...
// Debugging tool (shows code reached the point where this is called)
void flashLED() {
